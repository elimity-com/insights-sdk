...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'ZKgithub.com/elimity-com/insights-sdk/v2/gen/elimity/insights/common/v1alpha1'
